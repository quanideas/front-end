      ...
      <div className="container px-4">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div className="mt-56 flex flex-wrap justify-between z-0 p-2 bg-black bg-opacity-20 backdrop-blur-sm lg:mb-0 lg:bg-white lg:bg-opacity-90">
              <div className="mb-8 flex w-[330px] max-w-full">
                ...
                <div>
                  <h3 className="mb-[18px] text-md text-white lg:text-lg font-semibold lg:text-black ">
                    {t('contact.adress')}
                  </h3>
                  <p className="text-sm text-white lg:text-base text-body-color lg:text-black">
          ...
          <div className="w-full px-4 lg:w-5/12 xl:w-4/12 z-10">
            <div
            ...
            >
              ...
              <form>
                ...
                <div className="mb-0">
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center rounded-md text-white px-10 py-3 text-base font-medium transition duration-300 ease-in-out bg-primary hover:scale-105 transform"
                  >
                    {t('contact.send')}
                  </button>
                </div>
