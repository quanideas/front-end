...
const ProjectPermission = ({ roleId, roleProjectPermissions, onAddProject }) => {
  ...
  return (
    <div className="bg-white px-4 w-full lg:w-1/3 rounded-md shadow-lg md:shadow-sm shadow-green-200 lg:h-[650px] xl:h-[750px] overflow-y-auto">
      <div className="flex flex-row items-center justify-between sticky top-0 bg-white z-10">
        <h2 className="font-semibold bg-green-200 mb-2 mt-4 px-4 rounded-md">{t('general.project_permission')}</h2>
