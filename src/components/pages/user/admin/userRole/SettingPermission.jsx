 ...
 */
  ...
  return (
    <div className="bg-white z[10] px-4 w-full lg:w-1/3 rounded-md shadow-lg md:shadow-sm shadow-blue-200 laptop:h-[650px] desktop:h-[750px] overflow-y-auto">
      <div className="flex flex-row items-center justify-between sticky top-0 bg-white z-10">
        <h2 className="font-semibold bg-blue-200 mb-2 mt-4 px-2 rounded-md">{t('general.setting_permission')}</h2>
